...
\section{Локальные модели в задачи смеси экспертов}
...
\section{Вероятностное обоснование задачи смеси экспертов}
...
\section{Анализу качества аппроксимации смесью экспертов}
